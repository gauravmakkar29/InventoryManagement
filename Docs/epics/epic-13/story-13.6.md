...
## Acceptance Criteria
- [ ] AC1: When I open the Dashboard, I see a new "Environmental Risk" KPI card showing the fleet-wide average risk score with a trend indicator (improving/declining vs. last 24 hours)
- [ ] AC2: When the average risk score is below 50, the KPI card border turns red; between 50-70, amber; above 70, green
- [ ] AC3: When I click the "Environmental Risk" KPI card, I am navigated to the Inventory Geo Location tab with the heatmap enabled
- [ ] AC4: When there are blast radius results from the last 24 hours, a "Recent Impact Analysis" section appears below the KPIs showing up to 3 recent results with: origin device, affected count, and risk level
- [ ] AC5: When there are no recent blast radius results, the "Recent Impact Analysis" section shows "No recent impact analyses" with a link to "Run Simulation"
