...
- [x] AC1: When I view the Account/Service page, I see a segmented control toggle with two options: "Kanban" and "Calendar" with orange #FF7900 active state
- [x] AC2: When I click "Kanban", the Kanban board is displayed (default view)
- [x] AC3: When I click "Calendar", the monthly calendar view is displayed
- [x] AC4: When I switch views, any active filters are preserved and applied to the new view
- [x] AC5: When I switch views, the transition is smooth with no full page reload (150ms CSS transitions)
- [x] AC6: The last selected view is remembered via useState for the session
