...
- [x] AC1: When I am an Admin viewing a compliance item with status "Pending", I see an "Approve" button
- [x] AC2: When I click "Approve" and confirm, the item status changes to "Approved" and moves to the Approved tab
- [x] AC3: When I am an Admin viewing a compliance item with status "Approved" or "Pending", I see a "Deprecate" button
- [x] AC4: When I click "Deprecate" and confirm, the item status changes to "Deprecated" and moves to the Deprecated tab
- [x] AC5: When the status change succeeds, a toast notification confirms the action (e.g., "Compliance item approved")
- [ ] AC6: When the status change fails, the item reverts to its previous status and an error toast appears
- [x] AC7: When I am a Manager, Viewer, or other role, the Approve and Deprecate buttons are not visible
- [x] AC8: Tab counts update immediately after an approval or deprecation
