...
public class LoginPage {
    public static final String EMAIL_INPUT = LocateBy.css("input[type='email']");
    public static final String PASSWORD_INPUT = LocateBy.css("input[type='password']");
    public static final String SIGN_IN_BUTTON = LocateBy.css("button[type='submit']");
    public static final String PAGE_TITLE = LocateBy.text("IMS Gen 2");
